		...
		<div class="container">
			<div class="wrapper add_employee clearfix">
				...
				<form id="editemployee" class="clearfix" method="" action="">
					...
					<div class="input-box input-small right">
						<label for="lastname">Other Name</label><br>
...
<!--
					...
					<div class="section_subtitle left">Upload Docs (Optional)</div>
					...
					<div class="input-box input-upload-box left">
						...
						<input type="hidden" class="inputField kinresaddress" name="kinresaddress" value="<?php echo $kin_residence ?>">
						<input type="hidden" class="inputField kinphone" name="kinphone" value="<?php echo $phone_of_kin ?>">
						<input type="hidden" class="inputField relationship" name="relationship" value="<?php echo $relationship ?>">
						<input type="hidden" class="inputField resaddress" name="resaddress" value="<?php echo $residence_address?>">
						<input type="hidden" class="inputField resaddress" name="resaddress" value="<?php echo $residence_address?>">
						<input type="hidden" class="inputField fullname" name="fullname" value="<?php echo $next_of_kin ?>">
						<div class="error kinresaddresserror"></div>
				
						<input type="hidden" class="inputField kinresdirection" name="kinresdirection" value="<?php echo $kin_residence_direction ?>" >
