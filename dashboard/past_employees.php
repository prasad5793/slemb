<?php
	...
	//get number of rows
	$queryNum = $db_connect->query("SELECT COUNT(*) as postNum FROM sharp_emp WHERE status = 'submitted'");
...
?>
	...
	<div class="dash_logo">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/past_employees.php"><span class="nav-icon"><i class="fa fa-times"></i></span>submitted Applications</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">APPLICATION FOR REPATRIATION / DEPORTATION <br>All Past Applicant</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<?php
					$getemp = mysqli_query($db_connect, "SELECT * FROM sharp_emp WHERE status = 'submitted' ORDER BY id ASC");
